...
const Todo = () => {
    ...
    const getUserDetails = async()=>{
            ...
            if (docResponse.exists()){
                setUserDetails(docResponse.data())
            }
    } 


    const {name:username} = userDetails // alias
  ...
  return (
    ...
    <div className="container-fluid ">
        ...
        <div className='d-flex justify-content-around align-items-center'>
            <h3 className='text-center '>Welcome <span className='text-primary fw-bolder'>{username}</span></h3>
